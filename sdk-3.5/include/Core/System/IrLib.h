...
#define irLibTrapUnBind					(exgLibTrapLast+1)
#define irLibTrapDiscoverReq			(exgLibTrapLast+2)
#define irLibTrapConnectIrLap			(exgLibTrapLast+3)
#define irLibTrapDisconnectIrLap		(exgLibTrapLast+4)
#define irLibTrapConnectReq			(exgLibTrapLast+5)
#define irLibTrapConnectRsp			(exgLibTrapLast+6)
#define irLibTrapDataReq				(exgLibTrapLast+7)
#define irLibTrapLocalBusy				(exgLibTrapLast+8)
#define irLibTrapMaxTxSize				(exgLibTrapLast+9)
#define irLibTrapMaxRxSize				(exgLibTrapLast+10)
#define irLibTrapSetDeviceInfo		(exgLibTrapLast+11)
#define irLibTrapIsNoProgress			(exgLibTrapLast+12)
#define irLibTrapIsRemoteBusy			(exgLibTrapLast+13)
#define irLibTrapIsMediaBusy			(exgLibTrapLast+14)
#define irLibTrapIsIrLapConnected	(exgLibTrapLast+15)
#define irLibTrapTestReq				(exgLibTrapLast+16)
#define irLibTrapIAS_Add				(exgLibTrapLast+17)
#define irLibTrapIAS_Query				(exgLibTrapLast+18)
#define irLibTrapIAS_SetDeviceName	(exgLibTrapLast+19)
#define irLibTrapIAS_Next				(exgLibTrapLast+20)
#define irLibTrapIrOpen					(exgLibTrapLast+21)
#define irLibTrapHandleEvent			(exgLibTrapLast+22)
#define irLibTrapWaitForEvent			(exgLibTrapLast+23)

#define irLibTrapLast					(exgLibTrapLast+24)
