...
#define hsFtrValPowerKeyHoldKeyboardLock    0x0008  // Hold for keyboard to lock
...
// This feature indicates whether none of the wakeup
// keys other than the Power key can wake the device up or
// that a wakeup key just woke the device up when Keyboard
// Lock is on
#define hsFtrIDKeyboardLock		  12

#define hsFtrValKeyLockCantWake		  0x0001
#define hsFtrValKeyLockJustWoke		  0x0002
...
// keep some IDS reserved in case they are needed in Treo
#define hsChrReserved21               (hsChrRangeMin+21)
#define hsChrReserved22               (hsChrRangeMin+22)
#define hsChrReserved23               (hsChrRangeMin+23)
#define hsChrReserved24               (hsChrRangeMin+24)

// toggle the keyboard lock
#define hsChrKeyboardLock			  (hsChrRangeMin+25)

// delete the word at the cursor in a text edit field
#define hsChrDeleteWord				  (hsChrRangeMin+26)
...
typedef enum 
  {						  		// Type    : Description
	...
	hsAttrKeyboardLocked,       // Boolean : false=not locked, true=locked
	hsAttrKeyLockNextWakeTicks,	// UInt32  : Next time a key can wake the device up
								//			 when Keyboard Lock is active.
	hsAttrE911Mode = hsAttrKeyboardLocked
	                            // Boolean  : true = phone is in 911 mode
  } HsAttrEnum;
...
#ifdef BUILD_OPTION_SPRINGBOARD
...
#endif // BUILD_OPTION_SPRINGBOARD
...
// Unimplemented Springboard trap
