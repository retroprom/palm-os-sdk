...
------------------------------------------
Handspring NetPref Library Header Files
------------------------------------------
August 9, 2002
...
1. Compiling
        ...
        * You should also include the NetMaster Library header file.
        * NetPrefUtils.c/h contains code for utility functions (link and unlink)
          as discussed in the NetPref NetMaster API Document
