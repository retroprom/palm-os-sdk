/** Copyright (c) 1993-2002  Mentat Inc.
 ** dlpi.h 43.3, last change 06/21/02
 **/
...
static char	dlpi_h_sccsid[] = "@(#)dlpi.h	43.3";
#endif
...
/*
 * Primitives to signal link status
 */

#define DL_LINK_DOWN_IND        0x81
#define DL_LINK_UP_IND          0x82
...
/*
 * DL_LINK_UP_IND, M_PCPROTO type
 */
typedef struct dl_link_up_ind_s {
	ulong	dl_primitive;
} dl_link_up_ind_t;

/*
 * DL_LINK_DOWN_IND, M_PCPROTO type
 */
typedef struct dl_link_down_ind_s {
	ulong	dl_primitive;
} dl_link_down_ind_t;
...
union DL_primitives {
	...
	dl_link_down_ind_t	down_ind;
	dl_link_up_ind_t	up_ind;
};
...
#define	DL_IOC_DRIVER_OPTIONS	MIOC_CMD(MIOC_DLPI, 13)

/* driver_ops_type bits. */
#define	DRIVER_CKO_IN		0x00000001
#define	DRIVER_CKO_OUT		0x00000002
#define	DRIVER_CKO_OUT_DF	0x00000004
#define	DRIVER_TRAIN		0x00000008
#define	DRIVER_COW		0x00000010
#define	DRIVER_LFP		0x00000020
#define	DRIVER_LNP		0x00000040
#define	DRIVER_FASTPATH_IN	0x00000080

typedef struct driver_ops {
	uint	driver_ops_type;
	uint	driver_ops_type_1;
	uint	driver_ops_type_2;
} driver_ops_t;

/* cko_type bits. */
#define	CKO_INSERT	0x00000001
#define	CKO_ALGO_FAILED	0x00000002
#define	CKO_ALGO_PASSED	0x00000004
#define	CKO_ALGO_NONE	0x00000008
#define	CKO_ALGO_OTHER	0x00000010
#define	CKO_ALGO_UDP	0x00000020
#define	CKO_ALGO_TCP	0x00000040
#define	CKO_ALGO_IP	0x00000080

typedef struct cko_info {
	uint32_t cko_type;
	uint32_t cko_sum;
	uint32_t cko_start;
	uint32_t cko_insert;
