...
// 5.x uses 0x0137 for "input area control", but 6.0 and later will never
// send this, and we warned them not to use it.

// Added for PalmOS 6.0
...
#define	vchrHardContrast			0x020B		// Contrast button
#define	vchrHardAntenna				0x020C		// Antenna switch
...
//
// NOTE: The Palm range of virtual key character values used in the original
// Tornado, Emerald City, and Stu devices conflicts with the range of values
// assigned to Sony for use with their public jog dial API. As a result, the
// Palm definitions have been moved to the unique value range defined below.
// Only the first two virtual key event values from Sony's range (0x1700 and
// 0x1701) were used in the Palm devices, as a mechanism to launch the Clock
// application. These correspond to Sony's vchrJogUp and vchrJogDown events.
//
...
//		Sony
#define	vchrSonyMin					0x1700			//  16 command keys
...
//================================================================================
// NOTE: Be sure to check with any Partner Engineering engineer
// or project manager BEFORE defining any new vchrXXX definitions. The list of
// assigned virtual character values is maintained externally. Often ranges of
// values are kept confidential during the early stages of product development
// so what you see here may or may not be a truly complete list.
//================================================================================


// Alias names for some of the characters.
#define	chrPeriod					chrFullStop						// 0x002E
#define	chrSlash					chrSolidus						// 0x002F
#define	chrVerticalBar				chrVerticalLine					// 0x007C
