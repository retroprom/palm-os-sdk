 ...
 *
 * History:
 *	2003-03-14	CS	Rolled in rest of new 4.2 locale setting selectors
 *					(lmChoicePrimaryEmailEncoding...lmChoiceInboundDefaultVObjectEncoding).
 *
 *****************************************************************************/
