...
----------------------------------------------------------*/
switch ( pvtData.status.mode )
    {
    case gpsModeOff:
        SysCopyStringResource( tempStr, GPSIsOffString );
        break;

    case gpsModeSim:
        SysCopyStringResource( tempStr, simulatingGPSString );
        break;
...
----------------------------------------------------------*/
trkCenterX = skyvwRadius * sin( pvtData.velocity.track ) + 0.5;
trkCenterY = skyvwRadius * cos( pvtData.velocity.track ) + 0.5;
