...
//
// Function 1 of palmOne's Test SDIO card.......
//	Note: this is a write only port!
//
#define palmOneTestSDIOCardFunc1				1
#define palmOneTestSDIOCardFunc1Addr0			0		//Note, this is a write only port, (cheap hardware!)
#define palmOneTestSDIOCardFunc1Addr0LedOn		(1<<0)	//Set to 1=turn on the LED(see color below), 0=turn off LED
#define palmOneTestSDIOCardFunc1Addr0LedRed		(1<<1)	//Set to 1=Red LED, 0=Green LED (If LED is On)
#define palmOneTestSDIOCardFunc1Addr0LedGreen	(0<<1)	//Set to 1=Red LED, 0=Green LED (If LED is On)
#define palmOneTestSDIOCardFunc1Addr0NIntLevel	(1<<2)	//Set to 1=generate an interrupt, 0=reset an interrupt (assuming button has been released!)
...
#define SdioCardsOemManufacturer	0x00005672L	//palmOne test card
#define SdioCardsOemID				0x00004673L	//palmOne test card
#define SdioCardsOemFunctionNum 1				//This palmOne test card(s) comes in many flavors, 1-7 functions, but we only talk to function 1
